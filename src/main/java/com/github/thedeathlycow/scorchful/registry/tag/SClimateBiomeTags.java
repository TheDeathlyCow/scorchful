...
public final class SClimateBiomeTags {
    ...
    public static final TagKey<Biome> IS_HELL = SBiomeTags.register("climate/nether/is_hell");
    public static final TagKey<Biome> IS_NOT_HELL = SBiomeTags.register("climate/nether/is_not_hell");
